...
export const translations = {
  ko: {
    ...
    insertTable: '표 삽입',
    insertTableHelp: '3x2 표가 삽입됩니다. 내용을 직접 수정하세요.',
    selectTableSize: '표 크기 선택',
    enterRowsAndColumns: '삽입할 표의 행과 열 개수를 입력하세요',
    rows: '행 (Rows)',
    columns: '열 (Columns)',
    rowsHelp: '최소 1, 최대 20',
    columnsHelp: '최소 1, 최대 10',
    previewSize: '미리보기',
    insert: '삽입',
    tableEditHelp:
      '툴바의 "표 삽입" 버튼을 클릭하거나, 표 안에서 우클릭하여 행/열 추가, 셀 병합 등을 할 수 있습니다.',
    ...
    predefinedByForm: '양식에서 미리 지정됨 (수정 불가)',
    referrerLabel: '참조자',
  ...
  en: {
    ...
    close: 'Close',
    predefineApprovers: 'Predefine Approvers',
    optional: 'Optional',
    predefineApproversHelp:
    ...
    insertTableHelp: 'A 3x2 table will be inserted. Edit the content directly.',
    selectTableSize: 'Select Table Size',
    enterRowsAndColumns: 'Enter the number of rows and columns for the table',
    rows: 'Rows',
    columns: 'Columns',
    rowsHelp: 'Min 1, Max 20',
    columnsHelp: 'Min 1, Max 10',
    previewSize: 'Preview',
    insert: 'Insert',
    tableEditHelp:
      'Click the "Insert Table" button in the toolbar, or right-click inside a table to add/remove rows/columns, merge cells, etc.',
    ...
    predefinedByForm: 'Predefined by form (Cannot be changed)',
